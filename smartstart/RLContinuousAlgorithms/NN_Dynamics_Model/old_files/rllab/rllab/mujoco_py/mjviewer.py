...
class MjViewer(object):
    ...
    def __init__(self, visible=True, init_width=500, init_height=500, go_fast=False):
        ...
        self.init_width = 1500######init_width
    ...
    def autoscale(self):
        self.cam.lookat[0] = 10.0###self.model.stat.center[0]
        self.cam.lookat[1] = 1.0###self.model.stat.center[1]
        self.cam.lookat[2] = 0.0###self.model.stat.center[2]
        self.cam.distance = 12###0.5 * self.model.stat.extent
        self.cam.camid = -1
