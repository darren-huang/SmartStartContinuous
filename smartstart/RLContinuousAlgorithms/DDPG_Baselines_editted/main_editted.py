...
def run(env_id, seed, noise_type, layer_norm, evaluation, **kwargs):
    ...
    critic = Critic_Editted(layer_norm=layer_norm)
    actor = Actor_Editted(nb_actions, layer_norm=layer_norm)
    ...
    training_editted.train(env=env, eval_env=eval_env, param_noise=param_noise,
